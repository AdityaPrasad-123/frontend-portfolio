  ...
  return (
    ...
    <div className='bg-black text-white py-10 px-4 min-h-screen'>
      ...
      <div className='flex flex-col md:flex-row bg-slate-950 rounded-lg shadow-md w-full h-auto'>
        ...
        {/* Right Section (Form) */}
        <div className='md:w-1/2 w-full py-5 px-4'>
          <form onSubmit={onSubmit} className='space-y-4 sm:w-[800px] w-auto mx-auto px-2'>
            <div>
              <label htmlFor='name' className='block mb-1'>Your Name:</label>
              <input className='w-full h-12 border px-3 bg-slate-900 rounded' type='text' placeholder='Enter your name' name='name' required />
            </div>
            <div>
              <label htmlFor='email' className='block mb-1'>Your Email:</label>
              <input className='w-full h-12 border px-3 bg-slate-900 rounded' type='email' placeholder='Enter your email' name='email' required />
            </div>
            <div>
