...
const Projects = () => {
  return (
   ...
   <div className="bg-black text-white h-auto sm:h-screen"> <br /><br />
    ...
    <div className="w-auto h-60 bg-slate-700 text-white hover:border-amber-700 hover:border-3 sm:w-[500px]">
      <h1 className="sm:text-2xl text-xl font-medium hover:text-amber-600 text-center py-2">E-Commerce</h1>
      <p className="sm:text-xl text-xl font-medium text-center">
        Technology use:
        <br />
        HTML,CSS,Javascript,Reactjs<br/>mongodb,nodejs,express
      </p>
      ...
      <div className="w-auto h-60 bg-slate-700 text-white hover:border-amber-700 hover:border-3 sm:w-[500px]">
      <h1 className="sm:text-2xl text-xl font-medium hover:text-amber-600 text-center py-2">Chat Application</h1>
      <p className="sm:text-xl text-xl font-medium text-center">
        Technology use:
        <br />
        HTML,CSS,Javascript,Reactjs<br/>mongodb,nodejs,express
      ...
      <div className="w-auto h-60 bg-slate-700 text-white hover:border-amber-700 hover:border-3 sm:w-[500px]">
          <h1 className="sm:text-2xl text-xl font-medium hover:text-amber-600 text-center py-2">School Management System</h1>
          <p className="sm:text-xl text-xl font-medium text-center">
            Technology use:
             <br />
             HTML,CSS,Javascript,Reactjs<br/>mongodb,nodejs,express
